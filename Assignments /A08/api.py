...
Assingment : Fast api
Proffesor : Dr.griffin
Description : developing fast api to get different types of covid data from the dataset
"""
...
# function  that returns unique country names in the db
...
# function to get total numbers of cases according to input given
...
# function to get total numbers of deaths according to input given
...
# function that returns the country with maximum numbers of deaths 
...
# function that returns the country with minimum numbers of deaths 
...
# function to get avrage number of deaths per day according to the given input
